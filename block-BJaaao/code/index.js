...
let userName = prompt("Name of the user");
    userProfession = prompt("profession of the user");
    isAdult = confirm("adult or minor");
...
. Addition using prompt
  ...
  - Log using console.log [numA * numB]
*/
let numA = prompt("Enter a  first value");
    numB = prompt("Enter a  second value");
           alert(`sum of both numbers ${Number(numA + numB)}`);
           alert(` ${numA - numB}`);
           alert(` ${numA * numB}`);
